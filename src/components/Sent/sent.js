...
// );
    return(
        ...
        <List style={{width:'100%'}} >
              ...
              <span style={{position:'relative',left:'5px',fontSize:'.875rem',top:'2px',letterSpacing:'.2px'}} >To:GitHub</span>
              ...
              <div  style={{position:'relative',left:props.open ? '145px':props.ropen ?   '258px':'300px',fontSize:'.875rem',top:'2px'}} >
                <span>
                  14 Apr
                </span>
              </div>
