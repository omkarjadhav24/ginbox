...
// );
    return(
        ...
        <List style={{width:'100%'}} >
              ...
              <span id="spanStyle" style={{left:'350px', paddingBottom:'10px',paddingTop:'10px',paddingLeft:'8px',paddingRight:'8px', position:'relative',fontSize:'.875rem',top:'2px'}} > You don't have any saved drafts.<br/>
  <span>Saving a draft allows you to keep a message you aren't ready to send yet.</span> </span>
